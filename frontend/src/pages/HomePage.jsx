...
import {
    getOutgoingFriendReqs, getRecommendedUsers, getUserFriends,
    sendFriendRequest,
} from "../lib/api";
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="opacity-70">
                                    Discover the perfect developers based on your profile
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="card-body p-5 space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    {user.location && (
                                                        <div className="flex items-center text-xs opacity-70 mt-1">
                                                            <FiMapPin className="size-3 mr-1" />
                                                            {user.location}
                                                        </div>
                                                    )}
                                                </div>
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                <span className="badge badge-secondary">
                                                    Skills: {capitialize(user.skills)}
                                                </span>
                                                <span className="badge badge-outline">
                                                    Experience: {capitialize(user.experience)}
                                                </span>
                                            </div>
